...
## Transciption Factor Acticity inference with decoupleR
...
## Motif enrichment with MEME

For motif enrichment in UTRs of ToD candidates, we utilized AME from the MEME suite [@mcleayMotifEnrichmentAnalysis2010; @baileyMEMESuite2015]. To use AME for our analysis purpose we used the Memes R package [@nystromMemesMotifAnalysis2021]. AME works by comparing a set of target sequences, in this case, the UTRs of ToD candidates, against a set of background sequences to identify motifs that are significantly enriched in the target set.
